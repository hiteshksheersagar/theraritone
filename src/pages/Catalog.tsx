    ...
    <div className="min-h-screen" style={{ backgroundColor: '#121212' }}>
      ...
      <div className="pt-20 max-w-7xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="rounded-lg shadow-sm p-4 sm:p-6 mb-8 border border-[#C0C0C0]/30"
          style={{ 
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div className="lg:col-span-2 relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#C0C0C0]" size={20} />
              <Input
                placeholder="Search products..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="pl-10 bg-[#121212] border-[#C0C0C0]/30 text-[#FFFFFF] placeholder-[#C0C0C0] focus:border-[#B0EEFF] focus:ring-[#B0EEFF]"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2 border border-[#C0C0C0]/30 rounded-md focus:outline-none focus:ring-2 focus:ring-[#B0EEFF] bg-[#121212] text-[#FFFFFF]"
            >
          ...
          {filteredProducts.map((product, index) => (
            ...
            >
              ...
              <div className="w-full h-64 sm:h-72 lg:h-80 overflow-hidden relative">
                ...
                <div className="absolute top-3 right-3 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <motion.button
                    ...
                    className={`p-2 rounded-full transition-all duration-200 ${
                      wishlist.includes(product.id!)
                        ...
                        : 'bg-black/60 text-white hover:bg-[#B0EEFF]/30 border border-[#B0EEFF]/30'
                    }`}
                  >
                    <Heart 
                      size={16} 
                  ...
                  <motion.button
                    ...
                    className="p-2 bg-[#FFD700] text-[#121212] rounded-full hover:bg-[#B0EEFF] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <ShoppingBag size={16} />
                  </motion.button>
                </div>
              ...
              <div className="p-3 sm:p-4">
                <h3 className="font-medium text-[#FFFFFF] mb-1 text-sm sm:text-base truncate">{product.name}</h3>
                <p className="text-xs sm:text-sm text-[#C0C0C0] mb-2">{product.category}</p>
                <div className="flex items-center justify-between mb-2">
                  <p className="text-base sm:text-lg font-semibold text-[#FFFFFF]">₹{product.price}</p>
                  {/* Clean stock status */}
                  {product.stock > 0 ? (
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-[#C0C0C0]">No products found matching your criteria.</p>
            <Button 
              onClick={() => {
                setSearchQuery('');
                setFilters({
              ...
              className="mt-4 bg-[#FFD700] text-[#121212] hover:bg-[#B0EEFF]"
            >
              Clear Filters
            </Button>
          </div>
